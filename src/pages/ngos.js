...
const Page = () => {
  ...
  const getNgos = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get('http://localhost:4000/api/v1/admin/ngos', {
          headers: {
        ...
        <Container maxWidth="xl">
          <Stack spacing={3}>
            <Stack direction="row" justifyContent="space-between" spacing={4}>
              <Stack spacing={1}>
                <Typography variant="h4">NGOs</Typography>
              </Stack>
            </Stack>
            <CompaniesSearch />
