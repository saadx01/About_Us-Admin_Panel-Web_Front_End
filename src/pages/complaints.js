...
import { ComplaintsTable } from 'src/sections/complaints/complaints-table';
import { ComplaintsSearch } from 'src/sections/complaints/complaints-search';
...
const Page = () => {
  ...
  const getComplaints = () => {
    ...
    const fetchComplaints = async () => {
      try {
        const response = await axios.get(`${API_URL}projects/complains/all-complains`, {
          headers: {
  ...
  return (
    <>
      <Head>
        <title>Complaints | About Us</title>
      </Head>
